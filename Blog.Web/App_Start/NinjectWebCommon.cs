...
namespace Blog.Web.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            var modules = new INinjectModule[] { new ServiceModule("BlogConnection") };
        ...
        {
            System.Web.Mvc.DependencyResolver.SetResolver(new Blog.Web.Util.NinjectDependencyResolver(kernel));
        }
    }
}
